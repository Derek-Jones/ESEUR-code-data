README file for data extracted from MDP database.  Friday, December 17, 2004 at 11:27:01
...
CM1_product_hierarchy.csv
CM1_defect_product_relations.csv
CM1_dynamic_defect_data.csv
CM1_static_defect_data.csv
CM1_requirement_product_relations.csv
CM1_product_module_metrics.csv
CM1_product_requirement_metrics.csv
CM1_odc_type.csv
************************************************************************
...
Field descriptions for CM1_product_module_metrics.csv
------------------------------------------------------------------------
...
Field descriptions for CM1_product_requirement_metrics.csv
------------------------------------------------------------------------
MODULE - The unique numeric identifier of the product.
...
Field descriptions for CM1_product_hierarchy.csv
------------------------------------------------------------------------
...
Field descriptions for CM1_defect_product_relations.csv
------------------------------------------------------------------------
...
Field descriptions for CM1_requirement_product_relations.csv
------------------------------------------------------------------------
MODULE_ID - The unique numeric identifier of the module.
...
file for project CM1 because these values do not change over the life of a
defect.  Future projects may have these values excluded from this file.
Field descriptions for CM1_static_defect_data.csv
------------------------------------------------------------------------
...
Field descriptions for CM1_dynamic_defect_data.csv
------------------------------------------------------------------------
DEFECT_ID - The unique numeric identifier of the defect.
...
Field descriptions for CM1_odc_type.csv
------------------------------------------------------------------------
DEFECT_ID - The unique numeric identifier of the defect.
