README file for data extracted from MDP database.  Wednesday, April 28, 2004 at 10:37:53
...
KC3_product_hierarchy.csv
KC3_defect_product_relations.csv
KC3_dynamic_defect_data.csv
KC3_static_defect_data.csv
KC3_product_module_metrics.csv
KC3_odc_activity.csv
KC3_odc_type.csv
KC3_odc_age.csv
************************************************************************
...
Field descriptions for KC3_product_module_metrics.csv
------------------------------------------------------------------------
...
Field descriptions for KC3_product_hierarchy.csv
------------------------------------------------------------------------
...
Field descriptions for KC3_defect_product_relations.csv
------------------------------------------------------------------------
...
file for project KC3 because these values do not change over the life of a
defect.  Future projects may have these values excluded from this file.
Field descriptions for KC3_static_defect_data.csv
------------------------------------------------------------------------
...
Field descriptions for KC3_dynamic_defect_data.csv
------------------------------------------------------------------------
DEFECT_ID - The unique numeric identifier of the defect.
...
Field descriptions for KC3_odc_activity.csv
------------------------------------------------------------------------
DEFECT_ID - The unique numeric identifier of the defect.
...
Field descriptions for KC3_odc_type.csv
------------------------------------------------------------------------
DEFECT_ID - The unique numeric identifier of the defect.
...
Field descriptions for KC3_odc_age.csv
------------------------------------------------------------------------
DEFECT_ID - The unique numeric identifier of the defect.
