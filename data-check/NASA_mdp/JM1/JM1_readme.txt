README file for data extracted from MDP database.  Monday, February 14, 2005 at 17:44:49
...
JM1_product_hierarchy.csv
JM1_defect_product_relations.csv
JM1_dynamic_defect_data.csv
JM1_static_defect_data.csv
JM1_requirement_product_relations.csv
JM1_product_module_metrics.csv
JM1_product_requirement_metrics.csv
JM1_odc_activity.csv
JM1_odc_target.csv
************************************************************************
...
Field descriptions for JM1_product_module_metrics.csv
------------------------------------------------------------------------
...
Field descriptions for JM1_product_requirement_metrics.csv
------------------------------------------------------------------------
MODULE - The unique numeric identifier of the product.
...
CONDITIONAL - Represents whether the requirement will be addressing more than one condition.
	 This indicates a higher level of complexity in dealing with multiple conditions within
	 the requirement (i.e., If, when, in the event of).
...
Field descriptions for JM1_product_hierarchy.csv
------------------------------------------------------------------------
CSCI_ID	- The unique numeric identifiers of the CSCIs.
MODULE_ID - The unique numeric identifiers of the modules contained by the CSCIs.
...
Field descriptions for JM1_defect_product_relations.csv
------------------------------------------------------------------------
...
Field descriptions for JM1_requirement_product_relations.csv
------------------------------------------------------------------------
MODULE_ID - The unique numeric identifier of the module.
REQUIREMENT_ID - The unique numeric identifier of the associated requirement.
------------------------------------------------------------------------
...
file for project JM1 because these values do not change over the life of a
defect.  Future projects may have these values excluded from this file.
Field descriptions for JM1_static_defect_data.csv
------------------------------------------------------------------------
...
Field descriptions for JM1_dynamic_defect_data.csv
------------------------------------------------------------------------
DEFECT_ID - The unique numeric identifier of the defect.
...
Field descriptions for JM1_odc_activity.csv
------------------------------------------------------------------------
DEFECT_ID - The unique numeric identifier of the defect.
...
Field descriptions for JM1_odc_target.csv
------------------------------------------------------------------------
DEFECT_ID - The unique numeric identifier of the defect.
