README file for data extracted from MDP database.  Monday, July 26, 2004 at 18:47:23
...
PC2_product_hierarchy.csv
PC2_defect_product_relations.csv
PC2_dynamic_defect_data.csv
PC2_static_defect_data.csv
PC2_product_module_metrics.csv
PC2_odc_type.csv
************************************************************************
...
Field descriptions for PC2_product_module_metrics.csv
------------------------------------------------------------------------
...
Field descriptions for PC2_product_hierarchy.csv
------------------------------------------------------------------------
...
Field descriptions for PC2_defect_product_relations.csv
------------------------------------------------------------------------
...
file for project PC2 because these values do not change over the life of a
defect.  Future projects may have these values excluded from this file.
Field descriptions for PC2_static_defect_data.csv
------------------------------------------------------------------------
...
Field descriptions for PC2_dynamic_defect_data.csv
------------------------------------------------------------------------
DEFECT_ID - The unique numeric identifier of the defect.
...
Field descriptions for PC2_odc_type.csv
------------------------------------------------------------------------
DEFECT_ID - The unique numeric identifier of the defect.
