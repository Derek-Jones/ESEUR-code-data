README file for data extracted from MDP database.  Monday, February 16, 2004 at 15:47:37
...
MW1_product_hierarchy.csv
MW1_defect_product_relations.csv
MW1_dynamic_defect_data.csv
MW1_static_defect_data.csv
MW1_product_module_metrics.csv
************************************************************************
...
Field descriptions for MW1_product_module_metrics.csv
------------------------------------------------------------------------
...
Field descriptions for MW1_product_hierarchy.csv
------------------------------------------------------------------------
...
Field descriptions for MW1_defect_product_relations.csv
------------------------------------------------------------------------
...
file for project MW1 because these values do not change over the life of a
defect.  Future projects may have these values excluded from this file.
Field descriptions for MW1_static_defect_data.csv
------------------------------------------------------------------------
...
Field descriptions for MW1_dynamic_defect_data.csv
------------------------------------------------------------------------
DEFECT_ID - The unique numeric identifier of the defect.
