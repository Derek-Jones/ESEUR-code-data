README file for data extracted from MDP database.  Monday, February 16, 2004 at 15:42:15
...
PC1_product_hierarchy.csv
PC1_defect_product_relations.csv
PC1_dynamic_defect_data.csv
PC1_static_defect_data.csv
PC1_requirement_product_relations.csv
PC1_product_module_metrics.csv
PC1_product_requirement_metrics.csv
PC1_odc_type.csv
************************************************************************
...
Field descriptions for PC1_product_module_metrics.csv
------------------------------------------------------------------------
...
Field descriptions for PC1_product_requirement_metrics.csv
------------------------------------------------------------------------
MODULE - The unique numeric identifier of the product.
...
Field descriptions for PC1_product_hierarchy.csv
------------------------------------------------------------------------
...
Field descriptions for PC1_defect_product_relations.csv
------------------------------------------------------------------------
...
Field descriptions for PC1_requirement_product_relations.csv
------------------------------------------------------------------------
MODULE_ID - The unique numeric identifier of the module.
...
file for project PC1 because these values do not change over the life of a
defect.  Future projects may have these values excluded from this file.
Field descriptions for PC1_static_defect_data.csv
------------------------------------------------------------------------
...
Field descriptions for PC1_dynamic_defect_data.csv
------------------------------------------------------------------------
DEFECT_ID - The unique numeric identifier of the defect.
...
Field descriptions for PC1_odc_type.csv
------------------------------------------------------------------------
DEFECT_ID - The unique numeric identifier of the defect.
