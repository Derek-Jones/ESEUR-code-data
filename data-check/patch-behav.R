...
ISR=read.csv(paste0(ESEUR_dir, "data-check/patching_published-ISR.csv.xz"), as.is=TRUE)
...
lines(p_sfit_1, col="green", xlim=c(1, 600), ylim=c(-3, 2), fun="cloglog")
