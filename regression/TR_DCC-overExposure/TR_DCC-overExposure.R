#
# TR_DCC-overExposure.R, 29 Jun 16
# Data from:
...
try(
lines(loess.smooth(t$Methods-t$Over.exposed.methods, t$Over.exposed.methods, span=0.9), col=loess_col)
   )
lines(loess.smooth(t_trunc$Methods-t_trunc$Over.exposed.methods, t_trunc$Over.exposed.methods, span=0.9), col=loess_col)
