...
# amr_mod=glm(lines.modified ~ lines.added, data=amr)
# amr_mod=glm(lines.modified ~ lines.removed, data=amr)
amr_mod=glm(lines.modified ~ lines.added+lines.removed, data=amr)

print(summary(amr_mod, correlation=TRUE))
