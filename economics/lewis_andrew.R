...
# Derek M. Jones
#
# TAG experiment_human idea_production-rate group_size
...
plot(0, type="n",
	...
	xlab="Minutes", ylab="Unique ideas\n")
...
lines(nex1$Minutes, nex1$Size.2, col=pal_col[3], lty=2)
lines(nex1$Minutes, nex1$Size.4, col=pal_col[2], lty=2)
lines(nex1$Minutes, nex1$Size.6, col=pal_col[1], lty=2)
