...
trial_params<-c(((start_params[1]/0.02)/(1-(start_params[1]/0.02)))^0.5,(start_params[2]/(1-start_params[2]))^0.5,(start_params[3]/(1-start_params[3]))^0.5,(start_params[4]/(1-start_params[4]))^0.5,((start_params[5])/(1-(start_params[5])))^0.5)
