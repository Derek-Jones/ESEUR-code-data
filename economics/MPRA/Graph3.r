...
plot(yrmth[3:length(X)],c(0,rep(max(predicted_pir_acq_no_eps),timelength-1)),col="White",type="l",xlab="Date",ylab="Units")
lines(yrmth[3:length(X)],actual_sales,col="Black",type="l")
lines(yrmth[3:length(X)],predicted_sales_eps,col="Red",type="l",lty=2)
lines(yrmth[3:length(X)],predicted_pir_acq_eps,col="Red",type="l",lty=2)
lines(yrmth[3:length(X)],predicted_sales_no_eps,col="Green",type="l",lty=3)
lines(yrmth[3:length(X)],predicted_pir_acq_no_eps,col="Green",type="l",lty=3)
