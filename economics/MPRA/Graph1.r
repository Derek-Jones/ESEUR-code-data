...
lines(1:(timeperiods-1), predicted_pirate_acquisitions, col=pal_col[1])
lines(1:(timeperiods-1), predicted_sales, col=pal_col[2])
lines(1:(timeperiods-1), actual_sales, col=pal_col[3])

legend(x="topleft", legend=c("Pirated copies", "Sales predicted", "Actual sales"), bty="n", fill=pal_col, cex=1.2)
