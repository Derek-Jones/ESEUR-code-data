...
plot(proc_sales$date, proc_sales$bit.8, col=pal_col[1],
	ylim=c(0, max(proc_sales$bit.8)),
	xlab="Date", ylab="Sales (thousands)\n\n")

points(proc_sales$date, proc_sales$bit.4, col=pal_col[2])
points(proc_sales$date, proc_sales$bit.16, col=pal_col[3])
