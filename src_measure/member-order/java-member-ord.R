...
{
m_or=read.csv(paste0(ESEUR_dir, "src_measure/member-order/", csv_file), sep=";",							as.is=TRUE)
...
vis_plot_1=get_vis_plot(pref_ent_order[1], TRUE)
vis_plot_2=get_vis_plot(pref_ent_order[2], TRUE)
vis_plot_3=get_vis_plot(pref_ent_order[3], TRUE)
vis_plot_4=get_vis_plot(pref_ent_order[4], TRUE)
