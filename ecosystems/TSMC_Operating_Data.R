#
# TSMC_Operating_Data.R, 26 May 20
# Data from:
# TSMC Historical Operating Data
# TSMC website
#
# Example from:
...
# Derek M. Jones
#
# TAG TSMC_revenue hardware_line-width
...
legend(x="topleft", legend=c("0.25um+", "0.18um", "0.15um", "0.11/0.13um", "90nm", "65nm", "40/45nm", "28nm", "16/20nm"),
 		inset=-c(0.00, 0.03), bty="n", fill=pal_col, cex=1.2)
...
legend(x="topleft", legend=c("Computer", "Communication", "Consumer", "Industrial/Standard"),
 		inset=c(0, -0.03), bty="n", fill=pal_col, cex=1.2)
