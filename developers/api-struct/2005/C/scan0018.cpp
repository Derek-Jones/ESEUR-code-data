...
struct SLocation { int _DUMMY_FIELD;};
struct SWeight { int _DUMMY_FIELD;};

// <NOTE> The following structs needed to be
// <NOTE> added so the code would compile.
struct SAcreage { int _DUMMY_FIELD;};
struct SAnimalType { int _DUMMY_FIELD;};

struct SFarm
{
/* 21 */    char * owner;  //* Owner of farm
/* 23 */    struct SLocation location;  //* Farm location
/* 1 */    struct SWeight weight_of_avg_shipment;  //* Weight of average shipment
/* 15 */    struct SAcreage acres_crops;  //* Farm acres used to grow crops
/* 25 */    struct SAcreage acres_animals;  //* Farm acres used to rear animals
/* 3 */    int * animal_counts;  //* Number of each kind of animal on farm
