...
struct doa_details
{
/* 1 */    struct date last_inspection;  //* Date of last official agricultural product food safety inspection
...
/* 4 */    struct date date_planted;  //* Date agricultural product started life
/* 8 */    struct date date_harvested;  //* Date agricultural product killed
/* 5 */    double market_value;  //* Agricultural product market value
/* * */    double average;
/* 12 */    _Bool organic;  //* Was organically produced
...
/* 14 */    struct address farm_location;  //* Location of farm
/* * */    int                products;
};
...
{
/* * */    enum Fish type;
/* 8 */    struct date date_killed;  //* Date agricultural product killed
/* 5 */    double market_value;  //* Agricultural product market value
};
...
/* 14 */    struct address business_address;  //* Location of farm
};
