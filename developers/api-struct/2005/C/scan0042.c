...
/* 11 */    _Bool isOrganic; 	//need more domain info to confirm that a mixed farm wouldn't get organic certification if only part of its production is organic  //* Produced organically
...
24)Antibiotics used
25)Average labor costs for raising kind of animal
*/
