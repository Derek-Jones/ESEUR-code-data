...
/* 15 */    BOOL antibiotics;   // 15  //* Antibiotics used
...
/* 7 */    BOOL fertilized;    // 7  //* Fertilizer used
/* 19 */    char * dateSown;    // 19  //* Date crop sown
/* 21 */    BOOL weedKilled;    // 21  //* Weed killer used
/* 24 */    BOOL organic;   // 24  //* Was organically produced
};
...
/* 14 */    double valuePerField;   // 14  //* Market value of acre of crop
/* 13 */    double weightAvShipment;    // 13  //* Weight of average shipment
/* 16 */    double avLabourCost;    // 16  //* Average labor cost for growing crop
};

struct Animal
{
/* 1 */    double marketValue; // 1  //* Market value of kind of animal
/* 10 */    double avLabourCost;    // 10  //* Average labor cost for raising kind of animal
};
