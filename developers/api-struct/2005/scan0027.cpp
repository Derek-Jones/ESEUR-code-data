...
/* * */    node n;
/* * */    type t;
/* 9 */    BOOL environ_friendly;  //* Method of transport is environment friendly
...
/* 2 */    BOOL affected_by_conjestion;  //* Arrival time affected by congestion
...
/* 1 */    time travel_time;  //* Travel time
};
