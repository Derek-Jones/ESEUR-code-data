...
t1=cor.test(cs1_aggreg_rank, cs2_aggreg_rank, method="kendal")
t2=cor.test(cs1_aggreg_rank, cs4_aggreg_rank, method="kendal")
t3=cor.test(cs2_aggreg_rank, cs4_aggreg_rank, method="kendal")

print(c(cs1=t1$estimate,
        cs2=t2$estimate,
        cs3=t3$estimate))
