...
{
par(col="red")
plot(red.vals, xlim=c(0, 820), ylim=c(0, 7),
          xlab="Work Days since Apr 2009", ylab="")
par(col="blue")
par(new=TRUE)
plot(blue.vals, xlim=c(0, 820), ylim=c(0, 7),
          xlab="", ylab="")
par(col="black")
par(new=TRUE)
...
points(three.day.totals, col="red")
...
plot(x, y, col="red",
	xlab="Bug fix starts", ylab="Slots free",
	xlim=c(0, 10), ylim=c(0, 20))

bot.list=bug.out.totals == bot

points(bug.fix.starts[bot.list], work.slots.avail[bot.list], col="blue")
