#
# feat_duration-7dig.R, 16 Sep 20
#
# Data from:
...
# Derek M. Jones
#
# TAG Agile_feature Agile_elapsed-time feature_elapsed-time working-day
...
legend(x="topright", legend=c("First 650 days", "After 650 days"), bty="n", fill=pal_col[-2], cex=1.2)
