...
# Juliana Botelho and Vinicius H. S. Durelli and Simone S. Borges and Andre T. Endo and Marcelo M. Eler and Marcio E. Delamaro and Rafael S. Durelli
#
# Example from:
...
s2=read.csv(paste0(ESEUR_dir, "sourcecode/sast_2017.csv.xz"), as.is=TRUE)
