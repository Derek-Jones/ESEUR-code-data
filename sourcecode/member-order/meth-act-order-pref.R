#
# meth-act-order-pref.R,  7 Jun 18
#
# Data from:
...
# Derek M. Jones
#
# TAG Java_fields Java_methods declaration_ordering
...
#vis_plot_3=get_vis_plot(pref_ent_order[3], m_subcat_order)
subcat_plot=get_vis_plot(pref_ent_order[4], m_subcat_order)
