...
# return Firefox version pairs containing common source code
...
plot_version_usage("v1.0", brew_col[1])
plot_version_usage("v1.5", brew_col[2])
plot_version_usage("v2.0", brew_col[3])
plot_version_usage("v3.0", brew_col[4])
plot_version_usage("v3.5", brew_col[5])
plot_version_usage("v3.6", brew_col[6])
